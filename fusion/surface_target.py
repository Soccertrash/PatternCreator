...
def sketch_placement(sketch: Any, development: dict, face: Any) -> Dict[str, float]:
    ...
    # Kein Vorzeichenspiel: die Abwicklung zaehlt ihr y bei Zylinder **und**
    # Kegel in Achsrichtung. Beim Kegel wandert stattdessen der Apex auf die
    # andere Seite des Sektors (Context.md 15.18).
